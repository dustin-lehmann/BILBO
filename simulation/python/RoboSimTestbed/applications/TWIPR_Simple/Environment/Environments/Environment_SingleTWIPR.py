...
from scioi_py_core.objects.twipr.EnvironmentTWIPR_objects import TWIPR_DynamicAgent
...
class Environment_SingleTWIPR_KeyboardInput(EnvironmentBase):
    ...
    def action_controller(self, *args, **kwargs):
        ...
        # print(f"Desired Speed {2 * (self.keys.keys['UP'] - self.keys.keys['DOWN'])}, True Speed: {self.agent1.state['v']}")
        pass
