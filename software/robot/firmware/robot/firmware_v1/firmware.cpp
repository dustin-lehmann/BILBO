...
//    // Drive initialization if motors are used
...
//            .direction_left = -1,
//            .direction_right = 1,
//            .torque_max = TWIPR_CONTROL_MAX_TORQUE,
//            .modbus_config = {
//                .huart = BOARD_RS485_UART,
//                .EN_GPIOx = BOARD_RS485_UART_EN_GPIOx,
//                .EN_GPIO_Pin = BOARD_RS485_UART_EN_GPIO_PIN,
//                .hardware = MB_UART_DMA,
//            },
//        };
//        this->drive.init(twipr_drive_config);
//
//        if (!this->drive.startup_check()) {
//            nop(); // Handle failure case
//            while (true) {
//
//            }
//            return;
