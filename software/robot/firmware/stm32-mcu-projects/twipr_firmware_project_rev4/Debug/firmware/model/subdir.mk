...
CPP_SRCS += \
J:/work_dir/work_dir/projects/testbed/robots/TWIPR/software/robot/firmware/robot/firmware_v1/model/twipr_model.cpp 

OBJS += \
./firmware/model/twipr_model.o 

CPP_DEPS += \
./firmware/model/twipr_model.d 


# Each subdirectory must supply rules for building sources it contributes
firmware/model/twipr_model.o: J:/work_dir/work_dir/projects/testbed/robots/TWIPR/software/robot/firmware/robot/firmware_v1/model/twipr_model.cpp firmware/model/subdir.mk
...
clean: clean-firmware-2f-model

clean-firmware-2f-model:
	-$(RM) ./firmware/model/twipr_model.cyclo ./firmware/model/twipr_model.d ./firmware/model/twipr_model.o ./firmware/model/twipr_model.su

.PHONY: clean-firmware-2f-model
