...
CPP_DEPS += \
./stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.d 


# Each subdirectory must supply rules for building sources it contributes
stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.o: /Users/lehmann/work_dir/work_dir/projects/testbed/robots/BILBO/software/robot/firmware/libraries/stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.cpp stm32_core_cpp_lib/memory/eeprom/subdir.mk
...
clean: clean-stm32_core_cpp_lib-2f-memory-2f-eeprom

clean-stm32_core_cpp_lib-2f-memory-2f-eeprom:
	-$(RM) ./stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.cyclo ./stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.d ./stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.o ./stm32_core_cpp_lib/memory/eeprom/core_memory_eeprom.su

.PHONY: clean-stm32_core_cpp_lib-2f-memory-2f-eeprom
