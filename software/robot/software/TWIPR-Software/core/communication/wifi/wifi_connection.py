...
class WIFI_Connection:
    ...
    def __init__(self, id: str = '', config: dict = None):
        ...
        self._udp_server_broadcast.registerCallback('rx', self._udp_serverBroadcast_rxCallback)
    ...
    def _tcp_decodeMessage(self, data):
        ...
        if not base_message.data_protocol_id == self.protocol.identifier:
            logging.warning(f"Received faulty TCP message with protocol {base_message.data_protocol_id}")
            return
