...
from robot.communication.serial.twipr_comm_serial import TWIPR_Serial_Interface
from robot.communication.spi.twipr_comm_spi import TWIPR_SPI_Interface
from robot.communication.wifi.twipr_comm_wifi import TWIPR_WIFI_Interface
...
class TWIPR_Communication:
    ...
    _enable_wifi: bool
    def __init__(self, board: RobotControl_Board, enable_wifi: bool = True):
        self.board = board

        self._enable_wifi = enable_wifi



        if self._enable_wifi:
        ...
        self.spi.registerCallback('rx_samples', self._stm32_rx_sample_callback)
